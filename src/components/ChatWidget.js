...
export default function ChatWidget() {
  ...
  return (
    <div className="fixed bottom-4 right-4 md:bottom-8 md:right-8 z-50">
      ...
      {!isOpen && (
        <button onClick={() => setIsOpen(true)} className="bg-brand-dark text-brand-volt h-16 w-16 rounded-full shadow-[0_0_20px_rgba(57,255,20,0.5)] flex items-center justify-center hover:scale-110 active:scale-95 transition-all relative">
          <div className="absolute -top-1 -right-1 w-4 h-4 bg-brand-volt rounded-full border-2 border-brand-dark animate-ping"></div>
